...
We see that Age is not a significant variable in determining a major of an person.

The base line of the model is someone from Berkeley and has a diet of Anything. From a diet perspective, we see that someone being: Vegetarian, Vegan Unkown or Other, are increase the odds of someone having a STEM Major. We do not see evidence that Kosher or Halal are different to Anything.
