...
Here we will look at the NYC flight data from the `nycflights13` package. The problem to investigate is to come up with a model that can predict when a flight's arrival time will be delayed.
...
Is there any associate with carrier and a plane being late?
...
flights_joined %>%  
  ...
  annotate(geom="label",x=4, y=0.25,label="Average Late %",size=6)+
